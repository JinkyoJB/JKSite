                ...
                {showModal && (
                  <div
                    ...
                    <div className='p-8 w-5/6 mx-auto rounded-lg h-5/6 ' style={{ backgroundColor: 'rgba(255,255,255,0.8)' }}>
                      <div
                        className="flex h-full justify-start flex-col overflow-scroll" >
                        <div className='DLP_auto'>
                          <h1 className="border-b-2 border-neutral-100 px-6 py-3 text-3xl font-medium leading-tight text-black">
                            DLP_auto
                          </h1>
                          <div className="p-16 text-black">
                            <div className="col1 w-full flex gap-2">
                              <div className="소재 row1 w-1/2 block rounded-lg p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-white">
                                <h2 className=' mb-2 text-xl font-medium leading-tight text-neutral-800'>소재 : 세라믹</h2>
                                <p>
